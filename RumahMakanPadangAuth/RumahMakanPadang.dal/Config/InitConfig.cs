...
namespace RumahMakanPadangAuth.dal.Config
{
    public static class InitConfig
    {
        ...
        public static List<TestUser> GetUsers()
        {
            ...
            new TestUser{SubjectId = "1111111", Username = "yahya", Password = "yahya",
                Claims =
                {
                    new Claim(JwtClaimTypes.Name, "yahya"),
                    new Claim(JwtClaimTypes.GivenName, "yahya"),
                    new Claim(JwtClaimTypes.FamilyName, "yahya"),
                    new Claim(JwtClaimTypes.Email, "ysaskar@gmail.com"),
                    new Claim("username", "ysaskar@gmail.com"),
                    new Claim(JwtClaimTypes.EmailVerified, "true", ClaimValueTypes.Boolean),
                    new Claim(JwtClaimTypes.WebSite, "http://yahya.com"),
                    new Claim(JwtClaimTypes.Address, @"{ 'street_address': 'One Hacker Way', 'locality': 'Heidelberg', 'postal_code': 69118, 'country': 'Germany' }", IdentityServer4.IdentityServerConstants.ClaimValueTypes.Json),
